...
Proof.
  ...
  unfold t_update. rewrite <- eqb_eq in H. destruct (x1 =? x2)%string.
  - contradiction.
  - reflexivity.
Qed.
(** [] *)
...
Proof.
  intros A m x v1 v2.
  unfold t_update. Check (functional_extensionality). 
...
Theorem t_update_same : forall (A : Type) (m : total_map A) x,
  (x !-> m x ; m) = m.
Proof.
  intros A m x. unfold t_update. apply functional_extensionality. intro x'.
